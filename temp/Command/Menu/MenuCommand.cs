...
{
    [CommandType("MenuCommand", (int)IdAccion.Menu, TipoAplicacion.WEBEXTERNA, TipoAplicacion.WEBEXTERNASECURITY, TipoAplicacion.API)]
    ...
    public class MenuCommand : ABMContextCommand
    {
        public override object ExecuteCommand(InCourseRequest inCourseRequest)
        {
            ...
            menuPrincipal = ms.GetMenuOrdenesItems(TiposAplicacion);
        ...
        {
            return new MenuOrdenesItem() { key = 1, actionId = 0, allowed = true, className = "", icon = "fa fa-sign-in", permissionMask = 0, title = "Inicio", url = "Main" };
        }
