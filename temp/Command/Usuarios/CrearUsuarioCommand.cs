...
{
    [CommandType("CrearUsuarioCommand", (int)IdAccion.AdministracionUsuariosWeb, TipoAplicacion.WEBEXTERNA, TipoAplicacion.DMA)]
    public class CrearUsuarioCommand : ABMContextCommand
    {
        ...
        {
            UserHelper.CrearUsuario(IdParty, IdUsuario, Nombre, LimiteOferta, LimiteOperacion, Bloqueado);
