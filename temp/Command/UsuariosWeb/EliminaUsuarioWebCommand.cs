...
{
    [CommandType("EliminaUsuarioWebCommand", (int)IdAccion.AdministracionUsuariosWeb, TipoAplicacion.WEBEXTERNASECURITY)]
    public class EliminaUsuarioWebCommand : UsuarioWebCommand
    {
