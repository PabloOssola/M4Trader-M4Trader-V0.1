...
{
    public class CommandServiceFactory : ServiceHostFactory
    {
        ...
        private void AddBindingForNetNamedPipe(ServiceHost serviceHost, Uri url)
        {
            ...
            ServiceEndpoint serviceEndpoint = serviceHost.AddServiceEndpoint(typeof(ICommandService), binding, address);
        }
        ...
        private void AddBindingForRest(ServiceHost serviceHost, Uri url)
        {
            ...
            ServiceEndpoint serviceEndpoint = serviceHost.AddServiceEndpoint(typeof(ICommandService), binding, "/Rest");
