...
{
    public class CommandServiceSistemaFactory : ServiceHostFactory
    {
        ...
        private void AddBindingForNetNamedPipe(ServiceHost serviceHost, Uri url)
        {
            ...
            ServiceEndpoint serviceEndpoint = serviceHost.AddServiceEndpoint(typeof(ICommandServiceSistema), binding, address);
        }
        ...
        private void AddBindingForRest(ServiceHost serviceHost, Uri url)
        {
            ...
            ServiceEndpoint serviceEndpoint = serviceHost.AddServiceEndpoint(typeof(ICommandServiceSistema), binding, "/Rest");
