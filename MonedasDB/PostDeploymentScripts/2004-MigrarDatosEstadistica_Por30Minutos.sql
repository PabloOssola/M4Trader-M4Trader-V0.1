...
SELECT @FechaInicial = '141231', @RuedaExcludia = 'REPO', @EstadoOperaciones = 'S', @Contador = 0, @MinutosRangoHorario = 30, @MinutosRangoHorarioPorMil = 3000
...
USE SIOPEL_1001
DROP INDEX siopel_owner.swoper_historico.IX_swoper_historico6
ALTER TABLE Siopel_1001.siopel_owner.swoper_historico DROP COLUMN FechaAlterada
